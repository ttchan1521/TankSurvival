...
namespace TDSTK
{
    ...
    public class TDS
    {
        ...
        public delegate void ResetAllEffectHandler();       //not in used
        public static event ResetAllEffectHandler onResetAllEffectE;
        public static void ResetAllEffect() { if (onResetAllEffectE != null) onResetAllEffectE(); }
