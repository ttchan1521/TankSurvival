...
public class LevelProgressionStats
{
    ...
    public bool sumRecursively = true;  //level càng cao, exp cần càng nhiều
    public float expTHM = 1.5f; //hệ số nhân
    public int expTHC = 10; //hệ số cộng
    ...
    public void VerifyExpList()
    {
        ...
        expThresholdList = PlayerProgression.GenerateExpTH(sumRecursively, expTHM, expTHC, levelCap); //list ngưỡng kinh nghiệm theo level
    }
